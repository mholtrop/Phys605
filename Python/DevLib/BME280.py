...
class BME280:
    ...
    def get_standby_time(self):
        ...
        if self._dev_id == 0x60:
            codes = {0b000: 0.5, 0b110: 10., 0b111: 20., 0b001: 62.5, 0b010: 125., 0b011: 250., 0b100: 500.,
                     0b101: 1000.}
        else:
            codes = {0b000: 0.5, 0b001: 62.5, 0b010: 125., 0b011: 250., 0b100: 500., 0b101: 1000.,
                     0b110: 2000., 0b111: 4000.}
    ...
    def set_standby_time(self, stb_time):
        ...
        if self._dev_id == 0x60:
            codes = {0.5: 0b000, 10.: 0b110, 20.: 0b111, 62.5: 0b001, 125.: 0b010, 250.: 0b011, 500.: 0b100,
                     1000.: 0b101}
        else:
            codes = {0.5: 0b000, 62.5: 0b001, 125.: 0b010, 250.: 0b011, 500.: 0b100, 1000.: 0b101, 2000.: 0b110,
                     4000.: 0b111}
